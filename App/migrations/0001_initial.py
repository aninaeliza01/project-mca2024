# Generated by Django 4.2.5 on 2023-10-31 15:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo_image', models.ImageField(blank=True, null=True, upload_to='media/fuel_station_logos')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App.locationdetails'),
        ),
        migrations.AddField(
            model_name='fuelstation',
            name='user',
